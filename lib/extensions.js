...
module.exports = function(realmConstructor, context) {
    ...
    if (realmConstructor.Sync) {
        ...
        let usernamePasswordProviderMethods = require('./username_password_provider_client_methods');
        Object.defineProperties(realmConstructor.App.UsernamePasswordProvider, getOwnPropertyDescriptors(usernamePasswordProviderMethods.static));
        Object.defineProperties(realmConstructor.App.UsernamePasswordProvider.prototype, getOwnPropertyDescriptors(usernamePasswordProviderMethods.instance));
